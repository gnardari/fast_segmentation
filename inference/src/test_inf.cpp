...
int main(int argc, char** argv){
  const char* modelPath = "/root/bags/models/tree_loam_4w_filter_cos.pb";
  const char* inpPath = "/root/bags/models/input1.png";
  const char* inpName = "inputs/X";
  const char* outName = "up23/BiasAdd";
